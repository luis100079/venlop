...
class GetController extends Controller
{
    ...
    public function list_photos(Request $request){
        ...
        if($request->type !== true){
          ...
          return Photo::with('myLikes', 'myComments', 'get_user')->orderBy('id', 'DESC')->get();
            ...
            return Photo::with('myLikes', 'myComments',  'get_user')->where('user', $request->user)->orderBy('id', 'DESC')->get();
    ...
    public function list_videos(Request $request){
        ...
        if($request->type !== true){
          ...
          return Video::with('myLikes', 'myComments', 'get_user')->orderBy('id', 'DESC')->get();
          ...
          return Video::with('myLikes', 'myComments', 'get_user')->where('user', $request->user)->orderBy('id', 'DESC')->get();
    ...
    public function list_posts(Request $request){
        ...
        if($request->type !== true){
          ...
          return Post::with('myLikes', 'myComments', 'user')->orderBy('id', 'DESC')->get();
          ...
          return Post::with('myLikes', 'myComments', 'user')->where('user_id', $request->user)->orderBy('id', 'DESC')->get();
